...
class PD_PCF_WIDGET extends \Elementor\Widget_Base
{
	...
	public function get_title() {
		return esc_html( 'Post and Category Filter', 'post-slider-for-elementor' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Default is 9', 'post-slider-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html( 'Filter Button Style', 'post-slider-for-elementor' ),
...
// print_r($settings_args);
	        ...
	        echo '<div
	        		class="pd-pcf-container '.$column_type_class.'"
					  ...
					  <?php
						  if( !empty($all_terms) ){
							  foreach ($all_terms as $term) {
							  	?>
  									<a href="#" class="pd-pcf-filter-btn" data-filter=".<?php echo $term['slug'].'-'.$term['term_id']; ?>"><?php echo $term['name']; ?></a>
							  	<?php
							  }
						  }
					  ?>

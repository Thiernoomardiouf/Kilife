...
<div class="logo-helper"><a href='https://trustyplugins.com' target="_blank">
 ...
 <?php
  ...
  ?>
   ...
   <li class="nav-item" role="presentation">
		<a class="nav-link" id="layouts-tab" data-toggle="tab" href="#layoutstab" role="tab" aria-controls="layouts-tab" aria-selected="false"><?php echo esc_html__('Layouts','category-ajax-filter');?> <br/><span class="info-bt"><?php echo esc_html__('Post Layout, Filter Layout','category-ajax-filter'); ?></span><span class="dashicons dashicons-visibility"></span></a>
	  </li>
	  <li class="nav-item" role="presentation">
